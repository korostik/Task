...
def Mini_Right_Rotation(tree): # текущий узел основного дерева, который подходит под условие балансировки малым правым вращением
    a_left = tree.left #b
    tree.left = None
